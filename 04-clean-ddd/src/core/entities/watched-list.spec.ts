...
describe('watched list', () => {
  ...
  it('should be to add an item even if it was removed before', () => {
    const list = new NumberWatchedList([1, 2, 3])
  ...
  it('should be to remove an item even if it was added before', () => {
    const list = new NumberWatchedList([1, 2, 3])
  ...
  it('should be to update watched list items', () => {
    const list = new NumberWatchedList([1, 2, 3])
